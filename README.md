...
Posterior a este análisis se puede utilizar el data set para diferentes objetivos, por ejemplo predecir el género a partir de la información de diferentes variables. Las conclusiones realizadas en este informe nos permiten validar los resultados que se puedan llegar a obtener. 
